            ...
            <form className="space-y-4 md:space-y-6" action="#">
              <div>
                ...
                <input
                  ...
                  name="email"
                  id="email"
                  className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-300 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-600">
                Don’t have an account yet? <a href="#" className="font-medium text-green-600 hover:underline dark:text-primary-500">Sign up</a>
              </p>
            </form>
          </div>
        </div>
