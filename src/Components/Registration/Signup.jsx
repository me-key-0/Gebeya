...
const SignupForm = ({ logo }) => {
    const handleSubmit = (e) => {
        ...
        //  to send data to backend or store locally
                        ...
                        <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="password"
                                    placeholder="••••••••"
                                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-300 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    required
                                />
                            </div>
                            <div>
