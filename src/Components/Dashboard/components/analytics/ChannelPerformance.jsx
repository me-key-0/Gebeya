...
const channelData = [
	{ name: "Organic Search", value: 2600 },
	{ name: "Paid Search", value: 3400 },
	{ name: "Direct", value: 2000 },
	{ name: "Social Media", value: 3780 },
...
const ChannelPerformance = () => {
	return (
		...
		>
			<h2 className='text-xl font-semibold text-green-700 mb-4'>Channel Performance</h2>
