...
const overviewData = [
	{ name: "Revenue", value: "ETB 1,234,567", change: 6.5, icon: DollarSign },
          ...
          '
				...
				>
					<div className='flex items-center justify-between'>
						<div>
							<h3 className='text-sm font-medium text-brown-400'>{item.name}</h3>
							<p className='mt-1 text-xl font-semibold text-brown-400'>{item.value}</p>
						</div>
